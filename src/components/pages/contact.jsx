...
function Contact() {
  ...
  return (
    <div className="font-montserrat ">
      ...
      <div className="hidden md:grid md:grid-cols-2 md:min-h-[100vh] md:px-10 py-32">
        <div className="text-sm grid grid-cols-1 gap-4 h-3/6">
        ...
        <div>
          <form className="grid grid-cols-1 gap-6" action="">
            ...
            <input className="input-border px-8" type="text" placeholder="First Name" />
            <input className="input-border px-8" type="email" placeholder="Mail" />
            <textarea className="input-border px-8 py-4 h-36" placeholder="Message"></textarea>
